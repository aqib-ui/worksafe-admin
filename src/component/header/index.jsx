...
const Header = ({
  ...
  useEffect(() => {
    const NotiFiCationIdea = async () => {
      ...
      const response = await fetch(
        `${baseUrl}/worksites/currentWorksite/${WorkSite}`,
        options,
      );
  ...
  const NotiFiCationIdea2 = async (id) => {
    ...
    const response = await fetch(
      `${baseUrl}/worksites/currentWorksite/${id}`,
      options,
    );
    const res = await response.json();
    navigate("/");
        ...
        <div className={Style.MainHeader}>
          <div className={Style.HeaderWrapper}>
            ...
            <div className={Style.WorkSiteDrop}>
              ...
              >
                ...
                {userRole !== null && userRole !== undefined && (
                  <Tooltip placement="right" title={"Logout"}>
                    <div onClick={logOut} className={Style.NavigationIcon}>
                      Logout
                    </div>
                  </Tooltip>
                )}
              ...
              <AdvanceSearch
                advanceModalSearchModal={advanceModalSearchModal}
                ...
                <Dropdown trigger={["click"]} menu={{ items }}>
                  <div className={Style.ProfileIcon}>
                    <h6>
                      ...
                      {UserName?.split(" ")[1]?.charAt(0, 0) !== undefined
                        ? UserName?.split(" ")[1]?.charAt(0, 0)
                        : null}
                    </h6>
                  </div>
                </Dropdown>
        ...
        {IsPromExp && (
          <div className={Style.WarningHeader}>
            <div>
              ...
              <p>
                Access to your data is temporarily restricted. To continue
                viewing and managing your worksite records, please renew your
                plan.
              </p>
            </div>
