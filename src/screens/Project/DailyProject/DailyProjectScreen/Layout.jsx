                ...
                <>
                    ...
                    <div className={Style.TabHeader}>
                        <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
                            <button style={location.pathname == "/project/my-project" ? { border: '1px solid #214CBC', color: "#214CBC" } : null} onClick={() => navigate('/project/daily-project')}>Daily Projects</button>
                            <Tooltip title={"Create Daily Project"}>
                                <button onClick={() => {
                                    removeTemp()
                                    navigate('/project/daily/create')
                                }} style={location.pathname == "/project/daily/create" ? { border: '1px solid #214CBC', color: "#214CBC" } : null}><FiPlus color='#214CBC' size={22} /></button>
                            </Tooltip>
                        </div>
                        {/* <div>
