...
const ProjectScreenRead = ({ ArchiveAssets, GetCompanyUser, WorkOrderReducer, AssetsReducer, PoiReducer, getDepartment, CreateDepartment, GetAllWorkOrderUnLink, getContractorId, deleteContractor, addContractorAC, UpdateContractorAC, GetAssetsByID, GetAllWorkOrderFilterLink }) => {
    ...
    console.log(assetDetail, 'ALDSKLAKSDLKLKLDK')
                    ...
                    <div className={Style.SecondaryHeader}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                {!assetDetail?.isArchived && assetDetail?.workSite?._id == workSite && (
                                ...
                                <div className={Style.FloatingFilter}>
                                    <div className={Style.basicInfoSec}>
                                        ...
                                        <div className={Style.MapInfoAll}>
                                            <div>
                                                <Tooltip arrow={false} align={'left'} placement='right' title={assetDetail?.department?.name}>
                                                    <p className={Style.GapZone}>{assetDetail?.department?.name}</p>
                                                </Tooltip>
                                            ...
                                            <span></span>
                                            <div>
                                                <Tooltip arrow={false} align={'left'} placement='right' title={assetDetail?.model?.name}>
                                                    <p className={Style.GapZone}>{assetDetail?.model?.name}</p>
                                                </Tooltip>
                                                <h6>Model</h6>
                                            </div>
                                            <span></span>
                                            <div>
                                                <p className={Style.GapZone}>{assetDetail?.year}</p>
                                                <h6>Year</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div className={Style.MapInfoAll}>
                                            {assetDetail?.polygon?.type == "Polyline" ?
                                                <>
                                                    <div>
                                                        <p>{Number(assetDetail?.polygon?.safetyZone).toFixed(2)} m</p>
                                                        <h6>Width Stroke</h6>
                                                    </div>
                                                    <span></span>
                                                </>
