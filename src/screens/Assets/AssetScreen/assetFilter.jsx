...
import { TASK_GET_ARCHIVED_ASSETS_COMPLETE, TASK_GET_ASSETS_COMPLETE } from "../../../../store/actions/types";
...
const AssetFilter = ({ setPage, setIsNext, AssetsReducer, loading, GetPOI, workSite, page, searchQuery, setParamsNew }) => {
                            ...
                            <div className={Style.FeildCol}>
                                ...
                                <Controller
                                    ...
                                    render={({ field: { onChange, value } }) => (
                                        <>
                                            <AddDataSelect adding={false} name={"assetType"} loading={AssetsReducer?.assetTypeLoading} disable={loading} addNewValue={CreatesetNewAssetTypeEx} setValue={onChange} value={value} optionData={assetTypeData} />
                                        </>
                                    )}
                                    name="assetType"
                                />
                        ...
                        <Col xxl={24} xl={24} lg={24} md={24} sm={24} xs={24}>
                            <div className={Style.FeildCol}>
                                ...
                                <Controller
                                    ...
                                    render={({ field: { onChange, value } }) => (
                                        <>
                                            <AddDataSelect adding={false} name={"department"} loading={AssetsReducer?.departmentLoading} disable={loading} addNewValue={CreateDepartmentEx} setValue={onChange} value={value} optionData={depatmentData} />
                                        </>
                                    )}
                                    name="department"
                                />
                        ...
                        <Col xxl={24} xl={24} lg={24} md={24} sm={24} xs={24}>
                            <div className={Style.FeildCol}>
                                ...
                                <Controller
                                    ...
                                    render={({ field: { onChange, value } }) => (
                                        <>
                                            <AddDataSelect adding={false} name={"model"} loading={AssetsReducer?.modelLoading} disable={loading} addNewValue={CreateModelEx} setValue={onChange} value={value} optionData={modelData} />
                                        </>
                                    )}
                                    name="model"
                                />
