        ...
        <>
            ...
            <div className={Style.TableSection}>
                <Table
                    ...
                    footer={() => (
                        <>
                            {AssetsReducer?.AssetsData.length > 0 && !AssetsReducer?.AssetsLoading &&
                                <>
                                    {isNext &&
                                        <div style={{ textAlign: "center", padding: "0 0" }}>
                                            <button
                                                onClick={() => setPage(prev => prev + 1)}
                                                disabled={AssetsReducer?.AssetsLoading}
                                                style={{
                                                    ...
                                                    padding: "6px 16px",
                                                    borderRadius: "4px",
                                                    cursor: AssetsReducer?.AssetsLoading ? "not-allowed" : "pointer",
                                                }}
                                            >
                                                {AssetsReducer?.AssetsLoading ? "Loading..." : "Load More"}
                                            </button>
                                        </div>
                                    }
                                </>
...
export default connect(mapStateToProps, AssetsAction)(MyAssets);
