...
// import { Button, Drawer, Dropdown, Empty, message, Select, Skeleton, Space, Spin, Table, Tag, Tooltip } from 'antd'
...
// function MyWorkSite({ WorkOrderReducer, GetMyArchivedWorkOrder, UnArchiveWorkOrder }) {
...
//     useEffect(() => {
//         const init = async () => {
//             const totalLegngth = await GetMyArchivedWorkOrder(workSite, page, searchQuery)
//             if (totalLegngth < 30) {
//                 setIsNext(false)
//             }
//         }
...
//             }
//         }
//         if (WorkOrderReducer.workOrderIsUnArchived) {
//             messageApi.destroy();
//             messageApi.open({
//                 type: "success",
//                 content: "Work order recover",
//             });
//             GetMyArchivedWorkOrder(workSite, page, searchQuery)
//         }
//     }, [
//         WorkOrderReducer.networkError,
//         WorkOrderReducer.workOrderIsUnArchived,
...
//                         <button className={Style.CheckBtn} onClick={() => UnArchiveWorkOrder(_id)} ><IoCheckmark size={20} color='white' /></button>
//                     </div>
//                 </div>
//             ),
//         });
...
//         localStorage.setItem("Xy9#qLT7pw!5kD+M3/=8&v==", eId)
//         window.location.reload()
//         window.location.href = '/workorder/edit';
//     }
...
//                 return (
//                     <>
//                         <Dropdown trigger={['click']} disabled={WorkOrderReducer.workOrderArchiveLoading || fileLoader} menu={{
//                             items: [
//                                 {
//                                     key: '4',
//                                     label: (
...
//                             ],
//                         }}>
//                             <MdOutlineSettings style={{ opacity: !WorkOrderReducer.workOrderArchiveLoading && !fileLoader ? 1 : 0.3, cursor: WorkOrderReducer.workOrderArchiveLoading && fileLoader ? "no-drop" : 'pointer' }} size={24} />
//                         </Dropdown>
//                     </>
//                 )
//             },
...
//                 <Table footer={() => (
//                     <>
//                         {WorkOrderReducer?.archivedWorkOrderData.length > 0 && !WorkOrderReducer?.workOrderLoading &&
//                             <>
//                                 {isNext &&
...
function ArchivedMeWorkOrder({ GetMyArchivedWorkOrder, PermissionReducer, WorkOrderReducer, GetMyAssignedWorkOrder, CompleteWorkOrder }) {
    const { downloadWorkOrderFile, fileLoader } = useDownloadNotification();
    // const { searchQuery } = useOutletContext();
                    ...
                    locale={{
                        emptyText: (
                            <div className={Style.EmptyTextTable}>
                                ...
                                <h4>no archived work orders yet</h4>
...
export default connect(mapStateToProps, WorkOrderAction)(ArchivedMeWorkOrder);